...
class SignupFragment: Fragment() {
    ...
    private fun initializer() {
        backButton.setOnClickListener {
            ...
            progressChip.text = String.format(resources.getString(R.string.forgot_question_format), 1, stackSize)
    ...
    private fun toPageTwo() {
        ...
        progressChip.text = String.format(resources.getString(R.string.forgot_question_format), 2, stackSize)
